...
EOF
    ...
    wget -q -O /root/warp "https://raw.githubusercontent.com/wibusantun/Warp/main/install_warp_proxy.sh" && chmod +x /root/warp
    bash /root/warp -yf || { log red "Failed to install WARP proxy."; exit 1; }
